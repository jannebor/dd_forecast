...
#save(VarSel, file="dataframes/Partition1/variable_selection/VarSel")
...
#save(VarSel, file="dataframes/Partition2/variable_selection/VarSel_terr")

#marine species:
load(file="dataframes/Partition2/train_mar_v2")
Boruta(category_group~., data=train_mar, maxRuns=50, doTrace=2) -> VarSel
#save(VarSel, file="dataframes/Partition2/variable_selection/VarSel_mar")
